...
RSpec.describe AgendasController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: agenda.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      agenda = Agenda.create! valid_attributes
      get :edit, params: {id: agenda.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Agenda" do
        expect {
          post :create, params: {agenda: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {agenda: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested agenda" do
        agenda = Agenda.create! valid_attributes
        put :update, params: {id: agenda.to_param, agenda: new_attributes}, session: valid_session
        agenda.reload
      ...
      it "redirects to the agenda" do
        agenda = Agenda.create! valid_attributes
        put :update, params: {id: agenda.to_param, agenda: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        agenda = Agenda.create! valid_attributes
        put :update, params: {id: agenda.to_param, agenda: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested agenda" do
      agenda = Agenda.create! valid_attributes
      expect {
        delete :destroy, params: {id: agenda.to_param}, session: valid_session
      }.to change(Agenda, :count).by(-1)
    end
